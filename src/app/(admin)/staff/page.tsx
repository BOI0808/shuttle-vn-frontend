        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              <th className="text-left text-[10px] font-mono uppercase text-gray-400 px-4 py-2.5">
                Nhân viên
              </th>
              <th className="text-left text-[10px] font-mono uppercase text-gray-400 px-4 py-2.5">
                Vai trò
              ...
              <th className="text-center text-[10px] font-mono uppercase text-gray-400 px-4 py-2.5">
                Thao tác
              </th>
            </tr>
          </thead>
